...
import com.byb.lazynetlibrary.net.http.cache.CacheHttpResponeHandlerBase;
import com.byb.lazynetlibrary.net.http.cache.CacheHttpThread;
...
import com.byb.lazynetlibrary.net.http.cache.SizeOfHttpCacheCalculator;
import com.byb.lazynetlibrary.net.http.cache.callback.AsyncCacheJsonResponseCallback;
import com.byb.lazynetlibrary.net.http.cache.callback.AsyncCacheTextResponseCallback;
...
import com.byb.lazynetlibrary.net.http.core.callback.ResponseCallbackInterface;
...
public class HttpRequestManager extends AsyncHttpClient {
    ...
    private void initHttpCache(Context context) {
        ...
        MemoryCache memoryCache = (MemoryCache) MemoryCacheUtils.createMemoryCache(
                context, 0.1f,
