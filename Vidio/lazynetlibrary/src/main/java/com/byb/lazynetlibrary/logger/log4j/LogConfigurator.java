...
*/   
package com.byb.lazynetlibrary.logger.log4j;
...
public class LogConfigurator {
	...
	/**输出到文件的日志格式*/
	private String filePattern = "%d - [%p::%c] - %m%n"/*"%d - [%p::%c::%t] - %m%n"*/;
	/**输出到控制台的日志格式*/
	...
	private void configureFileAppender() {
		...
		final Layout fileLayout = new PatternLayout(getFilePattern());//输出格式
