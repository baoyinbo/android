...
import com.byb.lazynetlibrary.cache.disk.naming.FileNameGenerator;
import com.byb.lazynetlibrary.cache.disk.read.BitmapReadFromDisk;
import com.byb.lazynetlibrary.cache.disk.read.BytesReadFromDisk;
import com.byb.lazynetlibrary.cache.disk.read.InputStreamReadFormDisk;
import com.byb.lazynetlibrary.cache.disk.read.SerializableReadFromDisk;
import com.byb.lazynetlibrary.cache.disk.read.StringReadFromDisk;
import com.byb.lazynetlibrary.cache.disk.write.BitmapWriteInDisk;
import com.byb.lazynetlibrary.cache.disk.write.BytesWriteInDisk;
import com.byb.lazynetlibrary.cache.disk.write.InputStreamWriteInDisk;
import com.byb.lazynetlibrary.cache.disk.write.SerializableWriteInDisk;
import com.byb.lazynetlibrary.cache.disk.write.StringWriteInDisk;
import com.byb.lazynetlibrary.cache.entity.CacheGetEntity;
import com.byb.lazynetlibrary.cache.entity.CachePutEntity;
import com.byb.lazynetlibrary.cache.memory.MemoryCache;
import com.byb.lazynetlibrary.cache.util.MemoryCacheUtils;
import com.byb.lazynetlibrary.logger.LazyLogger;
import com.byb.lazynetlibrary.utils.IoUtils;
import com.byb.lazynetlibrary.utils.bitmap.ImageDecodingInfo;
...
public class CacheLoaderManager {
	...
	public void init(Context context, FileNameGenerator diskCacheFileNameGenerator, long diskCacheSize,
		...
		MemoryCache memoryCache= (MemoryCache) MemoryCacheUtils.createLruMemoryCache(maxMemorySize);
