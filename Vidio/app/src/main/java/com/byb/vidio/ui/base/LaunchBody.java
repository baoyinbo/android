...
import com.byb.applifelibrary.ActivityStackManager;
import com.byb.vidio.MyApplication;

/**
 * 开启CommonActivity需要的参数包装类
 *
 */
public class LaunchBody {
    ...
    private boolean isLaunch(@NonNull Class<? extends Fragment> clazz, LaunchType launchType) {
        ...
        ActivityStackManager activityStackManager = MyApplication.getApplication().getActivityStackManager();
        switch (launchType) {
            case STANDARD:
                break;
            case SINGLE_TOP:
                ...
                break;
            case SINGLE_TASK:
                if (activityStackManager instanceof ViActivityStackManager) {
                    ViActivityStackManager stackManager = (ViActivityStackManager) activityStackManager;
