 ...
 */
public class ViDefaultLoadingView extends RelativeLayout {
    ...
    public ViDefaultLoadingView(Context context) {
        this(context, null);
    }

    public ViDefaultLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViDefaultLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        emptyViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.vi_comm_defaule_empty_view);
        errorViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.vi_comm_defaule_error_view);
        loadingViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.vi_comm_defaule_loading);
