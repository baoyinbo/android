...
package com.byb.vidio.net.http.cache;


import com.byb.lazynetlibrary.net.http.cache.CacheResponseListener;
import com.byb.vidio.model.BaseResponseModel;
import com.byb.vidio.net.HttpErrorCodeParseHelps;
import com.byb.vidio.net.WJResponseErrorCode;
            ...
            if (data != null) {
                if (data instanceof BaseResponseModel) {
                    ...
                    if ("OK".equals(model.getCode())) {
                        ...
                        onSuccessErrorManage(messageId, model.getCode(), model.getMsg());
                    }
                } else {
